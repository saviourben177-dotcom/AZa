    ...
    <form action={handleSubmit} className="mt-6 space-y-4">
      ...
      <div>
        ...
        <select
          name="role_id"
          required
          className="mt-1.5 w-full rounded-card border border-line-strong bg-surface px-4 py-3 text-[14px] text-ink shadow-card"
        >
          {roles.map((r) => (
      ...
      <div>
        ...
        <textarea
          ...
          className="mt-1.5 w-full resize-none rounded-card border border-line-strong bg-surface px-4 py-3 text-[13.5px] text-ink placeholder:text-ink/35 shadow-card"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="mt-1.5 w-full rounded-card border border-line-strong bg-surface px-4 py-3 text-[13.5px] text-ink placeholder:text-ink/35 shadow-card"
        />
      </div>
      ...
      <button
        type="submit"
        disabled={isPending}
        className="flex w-full items-center justify-center gap-2 rounded-card bg-aza py-3.5 text-[14.5px] font-bold text-white shadow-glow-accent disabled:opacity-60"
      >
