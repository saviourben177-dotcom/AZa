  ...
  return (
    <div className="px-4 pt-6 pb-10">
      ...
      <p className="mt-4 text-[14px] leading-relaxed text-ink/70">
        Aza helps people find real opportunities — scholarships, grants, hackathons,
        fellowships, internships, competitions, and gigs — in one place, without wading through
        outdated listings or scattered forwards.
      </p>
      ...
      <p className="mt-3 text-[14px] leading-relaxed text-ink/70">
        ...
        a directory of businesses, and tools like the CV Builder and Skills tracker to help you
        actually apply for what you find — wherever you are.
      </p>
